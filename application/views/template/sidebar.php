...
?>
    ...
    <!-- Nav Item - Charts -->
    <li class="nav-item <?php if ($this->uri->segment(1) == 'indikator') {echo "active";}?>">
    ...
    <!-- Nav Item - Charts -->
    <li class="nav-item <?php if ($this->uri->segment(1) == 'variabel') {echo "active";}?>">
...
<li class="nav-item <?php if ($this->uri->segment(1) == 'pegawai' || $this->uri->segment(1) == 'penilaianpegawai') {echo "active";}?>">
...
<!-- Nav Item - Charts -->
<li class="nav-item <?php if ($this->uri->segment(1) == 'ubahprofil') {echo "active";}?>">
