	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-form-title" style="background-image: url(<?php echo base_url('assets/assetslogin/') ?>images/bg-login.jpeg);">
					<span class="login100-form-title-1 py-3">
						&nbsp
					</span>
				</div>
